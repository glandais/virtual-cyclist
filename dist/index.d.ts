...
export declare abstract class AbstractPath {
    ...
    private readonly INITIAL_CHUNKS;
    private chunks;
...
export declare class Cyclist {
     ...
     */
    constructor(mKg: number, power: number, harmonics: boolean, maxBrakeG: number, cd: number, a: number, maxAngleDeg: number, maxSpeedKmH: number);
    /**
...
export declare class Elevation {
    static fixElevation(path: Path): Promise<Path>;
}
...
export declare class Enhancer {
    ...
    static enhancePath(path: Path): Promise<Path>;
    static enhance(course: CoursePhysics): Promise<Path>;
}

/**
 * Total number of fields per point in the chunked storage.
 */
export declare const FIELDS_PER_POINT = 31;

export declare const fieldToPointField: Record<PointFieldName, PointField>;
...
export declare abstract class GeneratedPath extends AbstractPath {
     ...
     */
    interpolatePoint(index1: number, index2: number, coef: number): Point;
}
...
export declare interface Point {
    ...
    readonly power: number;
    readonly pCyclistRaw: number;
    readonly pCyclistWheel: number;
    readonly pCyclistOptimalPower: number;
    readonly pAero: number;
    readonly pGravity: number;
    readonly pRollingResistance: number;
    readonly pWheelBearings: number;
    readonly pPowerFromAcc: number;
    readonly pPowerWheelFromAcc: number;
...
export declare enum PointFieldName {
...
export declare class PowerComputer {
     ...
     */
    computeCyclistPower(course: CoursePhysics, path: Path, equivalentMass: number, pointIndex1: number, pointIndex2: number): number;
    /**
...
export declare const powerProviderConstant: CyclistPowerProvider;
